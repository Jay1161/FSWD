...
function Cookies() {
  ...
  return (
    <div className="App">
      ...
      <button onClick={() => setCookieAndBackgroundColor('#546E7A')}>Red</button>
      <button onClick={() => setCookieAndBackgroundColor('BLue')}>Blue</button>
      <button onClick={() => setCookieAndBackgroundColor('Black')}>Black</button>
    </div>
  );
}
