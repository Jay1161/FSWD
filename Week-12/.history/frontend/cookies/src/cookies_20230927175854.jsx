...
function Cookies() {
  ...
  return (
    <div className="App">
      ...
      <button onClick={() => setCookieAndBackgroundColor('Red')}>Light Blue</button>
      <button onClick={() => setCookieAndBackgroundColor('BLue')}>Light Green</button>
      <button onClick={() => setCookieAndBackgroundColor('')}>Light Pink</button>
    </div>
  );
}
